#!/usr/bin/env python3
"""사이트맵에 올린 페이지가 '볼 것이 있는' 상태인지 배포 전에 본다.
...
무엇을 보나 — 확실한 결함 셋만 본다. 애매한 판정은 사람에게 넘긴다.
...
실행: python3 scripts/check-thin-pages.py        (통과 0, 실패 1)
      python3 scripts/check-thin-pages.py --list (전수 글자수만 출력)
"""
