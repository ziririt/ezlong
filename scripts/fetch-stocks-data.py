...
# 2026-06-18 업데이트: us-stock-top200.csv 기준 정렬 (BRK.B→BRK-B 변환)
US_TOP100 = [
    # 시총 순위 1~10 (TSM 7위 수동 추가 2026-06-19, LMT 101위로 밀려남)
    ...
    # 61~70
    'ADI',  'MCD',   'APH',  'TMUS', 'PEP',  'VZ',    'AMGN', 'TJX',  'NEE',  'BA',
    # 71~80
    'DIS',  'CRWD',  'BLK',  'TMO',  'SCHW', 'IBKR',  'APP',  'ETN',  'DE',   'T',
    # 81~90
    'GILD', 'ABT',   'UNP',  'BX',   'GLW',  'PFE',   'WELL', 'HON',  'UBER', 'ISRG',
    # 91~100
    'SHOP', 'COP',   'PLD',  'BKNG', 'CB',   'CRM',   'CVS',  'DHR',  'COF',  'SPGI',
]
