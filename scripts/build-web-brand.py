...
# 도메인 글자 — 다크 배경에서는 심볼과 같은 하늘색을 쓴다. 2026-08-07 개정:
# #3B82F6 은 개편 전 브랜드 블루와 같은 계열로 읽혀 새 심볼과 따로 놀았다.
# 흰 워드마크 + 하늘색 도메인 + 하늘색 나선 = 다크 헤더 세 요소가 한 팔레트.
# 라이트 배경은 하늘색이 흰 바탕에서 대비 1.9:1 로 읽히지 않아 진한 파랑 유지.
SUB_COLOR = {'color': '#2563EB', 'white': '#4FC3F7'}   # 도메인 글자
