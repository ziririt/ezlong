...
박는다. 지금 87항까지 있다. **이 번호 체계가 이 프로젝트의 척추다.**
...
### 4-0. 88항 - 원칙 3·4는 배포됐고 5·7·8·9가 남았다
...
진입 가능이라고 한다. 다음 미국 공휴일(11/26 추수감사절)에는 '장중' 오류가 그대로
재발한다. **원칙 3·4는 끝났다(2026-09-08 배포).** 다음은 출력 검문(원칙 5) —
