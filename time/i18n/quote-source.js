...
(function (root, factory) {
  ...
  function resolve(quote, opts) {
    try {
      ...
      // ── 영어 외의 언어: 링크를 아예 만들지 않는다 ──
      // 2026-07-29 운영자 확정. 일본어·중국어·스페인어·포르투갈어 사용자에게
      // 영문 검색어로 만든 아마존 링크를 붙여봐야, 자기 언어로 된 판본을
      // 찾아주지 못하고 "왜 영어 서점이 뜨지?"만 남는다. 링크가 없는 편이
      // 조용하고 정직하다 — 호출자는 null 을 받으면 버튼 자체를 숨긴다.
      //
      // 나중에 일본 아마존(.co.jp)·중국 서점을 붙이고 싶어지면 여기에
      // 언어별 분기를 더하면 된다. 지금 억지로 붙이지 않는 것뿐이다.
