...
(function (root) {
  ...
  "en": {
    "settings": {
      ...
      "alarm": {
        "heading": "Wake-up alarm",
        "standbyHint": "Tap the flip clock in StandBy to set your wake-up alarm right away.",
        "timeAria": "Wake-up time",
        "weekdayAria": "Repeat days",
        "weekday0": "Sun",
        "weekday1": "Mon",
        "weekday2": "Tue",
        "weekday3": "Wed",
        ...
        "weekday5": "Fri",
        "weekday6": "Sat",
        "repeatOnce": "With no days selected, it rings once.",
        "repeatWeekly": "Rings every week on the days you picked.",
        "snooze": "Snooze 10 minutes",
        "soundHeading": "Alarm music",
        "soundTabAria": "Kind of music",
        ...
        "sleepNow": "Current time",
        "sleepEdit": "Edit wake-up time",
        "sleepCancel": "Turn off alarm",
        "sleepCancelAsk": "This turns off the wake alarm. Press Start sleep to set it again.",
        "sleepCancelYes": "Turn off",
        "sleepCancelNo": "Keep it",
        "soundChange": "Change",
        "soundDone": "Done",
  ...
  "es": {
    "settings": {
      ...
      "alarm": {
        "heading": "Alarma para despertar",
        "standbyHint": "Toca el reloj flip en StandBy para configurar la alarma al instante.",
        "timeAria": "Hora de despertar",
        "weekdayAria": "Días de repetición",
        "weekday0": "Dom",
        "weekday1": "Lun",
        "weekday2": "Mar",
        "weekday3": "Mié",
        ...
        "weekday5": "Vie",
        "weekday6": "Sáb",
        "repeatOnce": "Si no eliges días, sonará una sola vez.",
        "repeatWeekly": "Sonará cada semana en los días elegidos.",
        "snooze": "Posponer 10 minutos",
        "soundHeading": "Música de la alarma",
        "soundTabAria": "Tipo de música",
        ...
        "sleepNow": "Hora actual",
        "sleepEdit": "Cambiar la hora",
        "sleepCancel": "Apagar alarma",
        "sleepCancelAsk": "Se apagará la alarma de despertador. Pulsa 'Iniciar sueño' para volver a activarla.",
        "sleepCancelYes": "Apagar",
        "sleepCancelNo": "Mantener",
        "soundChange": "Cambiar",
        "soundDone": "Listo",
  ...
  "ja": {
    "settings": {
      ...
      "alarm": {
        "heading": "起床アラーム",
        "standbyHint": "StandByのフリップ時計をタップすると、そのまま起床アラームを設定できます。",
        "timeAria": "起床時刻",
        "weekdayAria": "繰り返す曜日",
        "weekday0": "日",
        "weekday1": "月",
        ...
        "weekday5": "金",
        "weekday6": "土",
        "repeatOnce": "曜日を選ばなければ一度だけ鳴ります。",
        "repeatWeekly": "選んだ曜日に毎週鳴ります。",
        "snooze": "スヌーズ10分",
        "soundHeading": "アラームの音楽",
        "soundTabAria": "音楽の種類",
        ...
        "sleepNow": "現在時刻",
        "sleepEdit": "起床時刻を変更",
        "sleepCancel": "アラームを止める",
        "sleepCancelAsk": "起床アラームを止めます。もう一度かけるには「就寝開始」を押してください。",
        "sleepCancelYes": "止める",
        "sleepCancelNo": "そのまま",
        "soundChange": "変更",
        "soundDone": "閉じる",
  ...
  "ko": {
    "settings": {
      ...
      "alarm": {
        "heading": "기상 알람",
        "standbyHint": "Standby의 플립시계를 터치하면 바로 기상 알람 설정이 가능합니다.",
        "timeAria": "기상 시각",
        "weekdayAria": "반복 요일",
        "weekday0": "일",
        "weekday1": "월",
        ...
        "weekday5": "금",
        "weekday6": "토",
        "repeatOnce": "요일을 고르지 않으면 한 번만 울립니다.",
        "repeatWeekly": "고른 요일마다 매주 울립니다.",
        "snooze": "다시 알림 10분",
        "soundHeading": "알람 음악",
        "soundTabAria": "음악 갈래",
        ...
        "sleepCancel": "알람 끄기",
        "sleepCancelAsk": "기상 알람을 끕니다. 다시 걸려면 '취침 시작'을 누르세요.",
        "sleepCancelYes": "알람 끄기",
        "sleepCancelNo": "그대로 두기",
        "soundChange": "변경",
        "soundDone": "접기",
        "soundDefault": "기본 음악",
  ...
  "pt": {
    "settings": {
      ...
      "alarm": {
        "heading": "Alarme para acordar",
        "standbyHint": "Toque no relógio flip no StandBy para configurar o alarme na hora.",
        "timeAria": "Hora de acordar",
        "weekdayAria": "Dias de repetição",
        "weekday0": "Dom",
        "weekday1": "Seg",
        "weekday2": "Ter",
        "weekday3": "Qua",
        ...
        "weekday5": "Sex",
        "weekday6": "Sáb",
        "repeatOnce": "Sem dias escolhidos, toca uma única vez.",
        "repeatWeekly": "Toca toda semana nos dias escolhidos.",
        "snooze": "Soneca de 10 minutos",
        "soundHeading": "Música do alarme",
        "soundTabAria": "Tipo de música",
        "tabAcoustic": "Instrumental acústico",
        ...
        "sleepCancel": "Desligar alarme",
        "sleepCancelAsk": "O alarme de despertar será desligado. Toque em 'Iniciar sono' para ativá-lo novamente.",
        "sleepCancelYes": "Desligar",
        "sleepCancelNo": "Manter",
        "soundChange": "Alterar",
        "soundDone": "Concluir",
  ...
  "zh": {
    "settings": {
      ...
      "alarm": {
        "heading": "起床闹钟",
        "standbyHint": "轻触待机显示中的翻页时钟，即可直接设置起床闹钟。",
        "timeAria": "起床时间",
        "weekdayAria": "重复的星期",
        "weekday0": "日",
        "weekday1": "一",
        ...
        "weekday5": "五",
        "weekday6": "六",
        "repeatOnce": "不选择星期时只响一次。",
        "repeatWeekly": "在所选的星期每周响起。",
        "snooze": "稍后提醒 10 分钟",
        "soundHeading": "闹钟音乐",
        "soundTabAria": "音乐类型",
        "tabAcoustic": "原声演奏曲",
        ...
        "sleepEdit": "修改起床时间",
        "sleepCancel": "关闭闹钟",
        "sleepCancelAsk": "将关闭起床闹钟。如需重新设置，请按“开始就寝”。",
        "sleepCancelYes": "关闭",
        "sleepCancelNo": "保留",
        "soundChange": "更改",
        "soundDone": "收起",
