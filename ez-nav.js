...
(function () {
  ...
  var LANG_LABELS = {
    ja: { swing: 'スイングシグナル', strategy: 'スイング戦略', top9: 'TOP9集中分析', vs: '強気vs弱気', events: 'チャート：その日何が', regime: '市場局面の診断', prices: '株価情報', chart: 'AIチャート分析',
    ...
    zh: { swing: '波段信号', strategy: '波段策略', top9: 'TOP9集中分析', vs: '多空对比', events: '图表：那天发生了什么', regime: '市场阶段诊断', prices: '股价信息', chart: 'AI图表分析',
          targets: '目标股价', cycle: '市场周期', dca: '定投模拟器',
          folio: 'AI投资组合', compound: '复利计算器', retire: '退休计算器',
          backtest: '回测', risk: '风险偏好测评', quiz: '投资类型测试', game: '平衡游戏' },
    es: { swing: 'Señal de Swing', strategy: 'Estrategia Swing', top9: 'TOP9 a Fondo', vs: 'Alcista vs Bajista', events: 'Gráfico: qué pasó', regime: 'Régimen de mercado', prices: 'Precios', chart: 'Análisis IA',
    ...
    pt: { swing: 'Sinal de Swing', strategy: 'Estratégia Swing', top9: 'TOP9 a Fundo', vs: 'Alta vs Baixa', events: 'Gráfico: o que houve', regime: 'Regime de mercado', prices: 'Preços', chart: 'Análise IA',
  ...
  var linksKR = [
    ...
    ['/market-regime.html',         '시장 국면 진단<span style="display:inline-block;background:#ff3b30;color:#fff;font-size:11px;font-weight:800;border-radius:5px;padding:0 4px;margin-left:4px;vertical-align:middle;line-height:1.5;">NEW</span>', '시장 국면 진단 — 위험은 어디서 시작해 어디로 번지나 <span style="display:inline-block;background:#ff3b30;color:#fff;font-size:14px;font-weight:800;border-radius:6px;padding:0 6px;margin-left:4px;vertical-align:middle;">NEW</span>'],
